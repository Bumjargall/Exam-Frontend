...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: "Олон сонголттой, Богино хариулт, Нөхөх хариулт гэх мэт ",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Автомат үнэлгээ",
      description: "Шууд үр дүн, автомат оноо тооцоолол",
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "Хугацаатай тест",
      description: "Цагийн тоолуур, хугацаа хянагч",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Аюулгүй байдал",
      description: "Шалгалтын түлхүүр, сурагчийн бүртгэл",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "Энэ платформ манай багш нарын шалгалт авах ажлыг маш хялбарчилсан.",
      name: "Б. Сод-Од",
      title: "Нэст Эдүкэйшн Сургуулийн захирал",
    },
    {
      quote:
        "Оюутнуудын шалгалтын үр дүнг хянах, дүгнэх нь одоо хэд дахин хурдан болсон.",
      name: "Д. Цэцэгмаа",
      title: "Багш",
    },
    {
      quote:
        "Миний суралцах чадварт үнэхээр их тусалж байна. Гайхалтай систем.",
      name: "Г. Билгүүн",
      title: "Оюутан",
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            >
              ...
              <p className="text-xl mb-8 text-green-100">
                Орчин үеийн, хэрэглэхэд хялбар онлайн шалгалтын систем. Багш,
                сурагч хоёулаа ашиглахад таатай.
              </p>
        ...
        <div className="container mx-auto px-6">
          <motion.div className="text-center mb-16" {...fadeIn}>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Хялбар, үр дүнтэй шалгалтын системийг бид танд санал болгож байна
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <motion.div className="text-center mb-16" {...fadeIn}>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Бидний онлайн шалгалтын систем нь хэрэглэхэд маш хялбар
            </p>
          </motion.div>
              ...
              {[
                {
                  ...
                  title: "Бүртгүүлэх",
                  description:
                    "Багш эсвэл сурагчаар бүртгүүлж системд нэвтэрнэ",
                },
                {
                  step: "02",
                  title: "Шалгалт бэлтгэх/өгөх",
                  description:
                    "Багш нар шалгалт үүсгэж, сурагчид шалгалтыг өгнө",
                },
                {
                  step: "03",
                  title: "Үр дүнг харах",
                  description:
                    "Шалгалтын дүн, оноо, дүгнэлтийг харах боломжтой",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
